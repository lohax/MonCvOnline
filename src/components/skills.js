...
export default class Skills extends Component {
  render () {
    ...
    const dataDev = ['JavaScript ES6+', 'React.js', 'Vue.js', 'Node.js', 'JQuery', 'HTML5', 'CSS3', 'Sass', 'PHP', 'SQL', 'graphQL', 'Bootstrap', 'DHTMLX', 'Flexbox', 'Joomla', 'PWA', 'JAMstack', 'Gatsby', 'Contentful', 'Netlify', 'Webpack', 'Parcel', 'Express', 'Jest']
